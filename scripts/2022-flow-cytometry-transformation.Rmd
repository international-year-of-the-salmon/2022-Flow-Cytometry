...
franklin_event <- fc_franklin %>%
  ...
  mutate(zone = 5,
         event_type = "FC",
         maximumDepthInMeters = rep(c(25,50), times = 35),
         eventID = paste("IYS2022", "Franklin", zone, Station, event_type, maximumDepthInMeters, sep = "-"))
...
fc_emof <- fc_emof %>%
  ...
  mutate(measurementValueID = case_when(
    ...
    measurementType == "cells/ml" ~ "http://vocab.nerc.ac.uk/collection/P06/current/UCML/",
    measurementType == "fg POC/cell" ~ " ",
    measurementType == "ug C/L" ~ "http://vocab.nerc.ac.uk/collection/P06/current/UGPL/",
    measurementType == "ug C/ml" ~ "http://vocab.nerc.ac.uk/collection/P06/current/UUGS/"),
        measurementType = case_when(
    measurementType == "cells/ml" ~ "Concentration of cells per volume",
  ...
  select(-species) %>%
  mutate(measurementID = paste(eventID, row_number(), sep = "-"))
